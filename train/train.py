...
from utils import AverageMeter, initialize_logger, save_checkpoint, record_loss, \
    time2file_name, Loss_MRAE, Loss_RMSE, Loss_PSNR, calc_psnr
import datetime

parser = argparse.ArgumentParser(description="Spectral Recovery Toolbox")
parser.add_argument('--method', type=str, default='sst')
parser.add_argument('--pretrained_model_path', type=str, default=None)
parser.add_argument("--batch_size", type=int, default=20, help="batch size")
parser.add_argument("--end_epoch", type=int, default=300, help="number of epochs")
parser.add_argument("--init_lr", type=float, default=4e-4, help="initial learning rate")
# parser.add_argument("--outf", type=str, default='./exp_kaist/mst1_2/', help='path log files')
# parser.add_argument("--data_root", type=str, default=r'D:\Google Downloads\kaist')
parser.add_argument("--outf", type=str, default='./exp/sst/', help='path log files')
parser.add_argument("--data_root", type=str, default=r'D:\PycharmProjects\pythonProject\MST-plus-plus-master\dataset')
...
# loss function
criterion_msl1 = nn.L1Loss(reduction='mean')
criterion_mrae = Loss_MRAE()
criterion_rmse = Loss_RMSE()
criterion_psnr = Loss_PSNR()

# model
if opt.method == 'nmst_plus_plus':
...
scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, total_iteration, eta_min=1e-6)  #1e-6
...
# Resume
resume_file = r'D:\PycharmProjects\pythonProject\myproject\train_code\exp_kaist\mst1_2\2024_08_26_13_30_30\net_40epoch.pth'
    ...
    while iteration<total_iteration:
        ...
        for i, (images, labels) in enumerate(train_loader):
            ...
            if iteration % 1000 == 0:
                ...
                # Save model
                if torch.abs(mrae_loss - record_mrae_loss) < 0.01 or mrae_loss < record_mrae_loss or iteration % 5000 == 0 or psnr_loss > 31:
