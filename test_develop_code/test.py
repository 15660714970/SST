...
parser.add_argument('--method', type=str, default='hscnn_plus')
parser.add_argument('--pretrained_model_path', type=str, default=r'D:\PycharmProjects\pythonProject\myproject\model_zoo\hscnn_plus.pth')
# parser.add_argument('--pretrained_model_path', type=str, default=r'D:\PycharmProjects\pythonProject\myproject\train_code\exp_superskin\dstdun3\2024_06_17_14_53_24\net_1epoch.pth')
parser.add_argument('--outf', type=str, default='./exp/hscnn_plus/')
    ...
    for i, (input, target) in enumerate(val_loader):
        ...
        with torch.no_grad():
            ...
            if method=='awan':   # To avoid out of memory, we crop the center region as input for AWAN.
                ...
                output = model(input[:, :, 128:-128, 128:-128])
...
#     # Resume
#     resume_file = r'./model_zoo/restormer.pth'
